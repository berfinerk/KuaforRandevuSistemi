...
import com.example.ekrandeneme.databinding.ActivityMainKuaforDetayBinding

class MainKuaforDetay : AppCompatActivity() {
    private lateinit var binding: ActivityMainKuaforDetayBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityMainKuaforDetayBinding.inflate(layoutInflater)
